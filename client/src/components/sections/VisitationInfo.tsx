  ...
  const steps = [
    {
      ...
      description:
        "Para segurança de todos, solicitamos que as visitas sejam agendadas com antecedência via telefone ou WhatsApp.",
    },
    {
      icon: <Clock className="h-8 w-8 text-secondary" />,
      title: "Horários Flexíveis",
      description:
        "Visitas diárias das 14h às 17h. Horários especiais podem ser combinados com a administração.",
    },
    {
      icon: <UserCheck className="h-8 w-8 text-secondary" />,
      title: "Protocolos de Saúde",
      description:
        "Seguimos rigorosos protocolos de higiene. O uso de máscara pode ser solicitado dependendo da sazonalidade.",
    },
    {
      icon: <HeartHandshake className="h-8 w-8 text-secondary" />,
      title: "Acolhimento Familiar",
      description:
        "Incentivamos a participação da família. Dispomos de áreas privativas para momentos de qualidade.",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Sabemos o quanto a presença da família é fundamental para o
              bem-estar dos nossos residentes. Por isso, nosso processo de
              visitação é desenhado para ser simples, seguro e acolhedor,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="bg-white p-6 rounded-xl shadow-sm border border-border/50 hover:shadow-md transition-shadow"
                >
            ...
            <div className="relative z-10 bg-white p-2 rounded-[1.5rem] shadow-xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8 rounded-b-[1.2rem]">
                <p className="text-white font-medium text-lg italic">
                  "O carinho da família é o melhor remédio para a alma."
                </p>
              </div>
            </div>
          </div>
