...
export function Footer() {
  return (
    <footer
      className="bg-primary/5 border-t border-primary/10 pt-16 pb-8"
      id="contact"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              Nossa missão é proporcionar qualidade de vida e tranquilidade para
              as famílias.
            </p>
          </div>
        ...
        <div className="border-t border-primary/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground text-center md:text-left">
            © {new Date().getFullYear()} Casa de Repouso Bem Cuidar. Todos os
            direitos reservados.
          </p>
          <div className="flex gap-4">
            <a
              href="https://www.facebook.com/profile.php?id=61584097733055"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/casabemcuidar/"
              target="_blank"
              className="text-muted-foreground hover:text-primary transition-colors"
            >
              <Instagram size={20} />
