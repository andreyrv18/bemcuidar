...
import {Clock, Lock, LogOut, MapPin, Plus, Trash2, Users,} from "lucide-react";
                        ...
                        {!isAdmin ? (
                            ...
                            <div className="flex gap-2">
                                <Dialog open={isOpen} onOpenChange={setIsOpen}>
                                    <DialogTrigger asChild>
                                        <Button
                                            className="bg-primary hover:bg-primary/90 text-white rounded-full gap-2 shadow-lg">
                    ...
                    {events.length === 0 ? (
                        ...
                        events.map((event) => (
                            ...
                            >
                                {/* Date Block */}
                                <div
                                    className="bg-primary/5 min-w-[120px] flex flex-col items-center justify-center p-6 border-b md:border-b-0 md:border-r border-border/60">
